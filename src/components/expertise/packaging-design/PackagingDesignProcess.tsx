...
const steps = [
  {
    num: "01 / 04",
    title: "DISCOVER",
    description: "We review product details, competitors and requirements.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "CONCEPT",
    description: "We explore packaging directions and select one.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "DEVELOP",
    description: "We refine layout, hierarchy and product variants.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "PREPARE",
    description: "We deliver production files to supplied dielines.",
    active: false,
  },
];

export default function PackagingDesignProcess() {
  return (
