...
const items = [
  {
    num: "01 / 06",
    title: "DISCOVERY",
    description: "Understand goals, users and product constraints.",
  },
  {
    num: "02 / 06",
    title: "INFORMATION ARCHITECTURE",
    description: "Organize content and navigation clearly.",
  },
  {
    num: "03 / 06",
    title: "USER FLOWS",
    description: "Map key tasks before drawing screens.",
  },
  {
    num: "04 / 06",
    title: "WIREFRAMES",
    description: "Test structure and hierarchy early.",
  },
  {
    num: "05 / 06",
    title: "UI DESIGN",
    description: "Build a consistent visual interface system.",
  },
  {
    num: "06 / 06",
    title: "PROTOTYPES & HANDOFF",
    description: "Show interactions and prepare design files.",
  },
];

export default function UiUxWhatWeDesign() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-16 md:mb-20">
        ...
        <div className="lg:col-span-6 flex flex-col items-start lg:pt-4">
          <p className="text-neutral-900 text-lg sm:text-xl lg:text-2xl font-normal leading-relaxed max-w-lg">
            From the first flow to developer-ready screens.
          </p>
        </div>
      </div>
