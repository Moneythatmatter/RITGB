...
const steps = [
  {
    ...
    title: "UNDERSTAND",
    description:
      "We align on users, tasks and product goals.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "STRUCTURE",
    description:
      "We map flows, content and low-fidelity screens.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "DESIGN",
    description:
      "We build and refine the interface and prototype.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "HANDOFF",
    description:
      "We deliver screens, components and interaction notes.",
    active: false,
  },
];
