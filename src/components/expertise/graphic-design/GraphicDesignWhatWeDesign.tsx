...
const items = [
  {
    ...
    description: "Concept-led visuals for launches and promotions.",
  },
  {
    num: "02 / 06",
    title: "MARKETING COLLATERAL",
    description: "Brochures, flyers, presentations and sales material.",
  },
  {
    num: "03 / 06",
    title: "DIGITAL BANNERS",
    description: "Assets sized for websites, ads and email.",
  },
  {
    num: "04 / 06",
    title: "PRINT DESIGN",
    description: "Production-aware layouts for physical formats.",
  },
  {
    num: "05 / 06",
    title: "INFOGRAPHICS",
    description: "Complex information made easier to understand.",
  },
  {
    num: "06 / 06",
    title: "ART DIRECTION",
    description: "A consistent look across a full set of assets.",
  },
];

export default function GraphicDesignWhatWeDesign() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-16 md:mb-20">
        ...
        <div className="lg:col-span-6 flex flex-col items-start lg:pt-4">
          <p className="text-neutral-900 text-lg sm:text-xl lg:text-2xl font-normal leading-relaxed max-w-lg">
            Individual pieces designed as part of one recognizable visual world.
          </p>
        </div>
      </div>
