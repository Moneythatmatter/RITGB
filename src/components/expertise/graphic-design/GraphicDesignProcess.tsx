...
const steps = [
  {
    ...
    title: "BRIEF",
    description:
      "We clarify the audience, message, channel and required formats.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "CONCEPT",
    description:
      "We set a clear visual direction and hierarchy.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "DESIGN",
    description:
      "We build and refine the assets with feedback.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "DELIVER",
    description:
      "We export the agreed formats and editable source files.",
    active: false,
  },
];
