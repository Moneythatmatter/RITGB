...
const steps = [
  {
    ...
    title: "DISCOVER",
    description:
      "We learn your goals, audience, competitors and existing perception.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "DEFINE",
    description:
      "We shape positioning, personality and a focused creative direction.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "DESIGN",
    description:
      "We develop and refine the identity system with your feedback.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "DELIVER",
    description:
      "We hand over final files, guidelines and launch-ready assets.",
    active: false,
  },
];
