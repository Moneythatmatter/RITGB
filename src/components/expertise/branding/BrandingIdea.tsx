...
const badges = ["Positioning", "Identity", "Consistency"];

export default function BrandingIdea() {
  ...
  return (
    ...
    >
      {/* Top Header with Green Dot and Horizontal Divider */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-6">
          <h2 className="idea-headline font-(family-name:--font-right-grotesk) text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] font-black uppercase leading-[0.92] tracking-[-0.03em] text-black">
            IF IT LOOKS LIKE EVERYONE ELSE, WHY WOULD ANYONE REMEMBER IT?
          </h2>
        </div>

        {/* Right: Paragraph & Badges */}
        <div className="idea-right lg:col-span-6 flex flex-col items-start lg:pt-2">
          <p className="text-neutral-900 text-lg sm:text-xl lg:text-2xl font-normal leading-relaxed mb-8 max-w-xl">
            We uncover what makes your business different, then turn it into a
            recognizable brand system that works everywhere your audience meets
            you.
          </p>
