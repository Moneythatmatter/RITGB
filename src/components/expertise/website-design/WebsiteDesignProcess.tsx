...
const steps = [
  {
    ...
    title: "DISCOVER",
    description:
      "We review your brand, audience, goals, content and current website if you have one.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "STRUCTURE",
    description:
      "We map the pages, key journeys and wireframes before moving into visual design.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "DESIGN",
    description:
      "We create and refine the agreed pages for desktop, tablet and mobile.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "HANDOFF",
    description:
      "We organize components, states and interaction notes for the development team.",
    active: false,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-16 md:mb-20">
        ...
        <div className="lg:col-span-6 flex flex-col items-start lg:pt-4">
          <p className="text-white text-lg sm:text-xl font-light leading-relaxed max-w-md opacity-90">
            One clear path from what your audience needs to the pages your team can
            bring to life.
          </p>
        </div>
      </div>
