...
const steps = [
  {
    ...
    title: "BRIEF",
    description:
      "We identify the message, platform and brand requirements.",
    active: true,
  },
  {
    num: "02 / 04",
    title: "DIRECTION",
    description: "We develop a consistent visual approach.",
    active: false,
  },
  {
    num: "03 / 04",
    title: "CREATE",
    description: "We design and revise the agreed assets.",
    active: false,
  },
  {
    num: "04 / 04",
    title: "EXPORT",
    description: "We supply platform sizes and editable masters.",
    active: false,
  },
];

export default function SocialMediaCreativesProcess() {
  return (
