...
export default function Portfolio() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#f0eeea]">
      <div className="pt-37.5 pb-30 md:py-0 md:py-0">
        ...
        <div className="md:pb-24 px-4 md:px-27.75">
          <div className="overflow-hidden">
            <h2 className="portfolio-line font-(family-name:--font-right-grotesk) text-[8vw] md:text-[4vw] font-black leading-none tracking-[-0.02em] whitespace-nowrap uppercase text-center">
              Proof We Didn’t Just <br /> Watch Marketing Podcasts
            </h2>
          </div>
          {/* <div className="overflow-hidden">
